...
namespace COM.BUS.SanPham
{
    public class SanPhamBUS
    {
        ...
        public BaseResultMOD dsSanPhamAdmin(int page, int s)
        {
            var result = new BaseResultMOD();
            try
            {
                if (page > 0) { result = new SanPhamDAL().getdsSanPhamAdmin(page, s); }
        ...
        public BaseResultMOD dsSanPhamAdminSearch(string keyword,int page, int s)
        {
            ...
            try
            {
                if (page > 0) { result = new SanPhamDAL().getdsSanPhamAdminSearch(keyword, page, s); }
